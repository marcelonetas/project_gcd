Codebook
========
Codebook was generated on 2018-02-23 10:57:37 during the same process that generated the dataset. See `run_analysis.md` or `run_analysis.html` for details on dataset creation.
...
Save data table objects to a tab-delimited text file called `Resulted_Dataset.txt`.


```r
f <- file.path(path, "Resulted_Dataset.txt")
